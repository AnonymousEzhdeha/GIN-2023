...
class GKNSmoothingCell(k.layers.Layer):
    """Implementing the GKN cell. This implementation is a subclass of the Keras Layer Class, such
    ...
    def call(self, inputs, states, **kwargs):
        """ similar to the LSTM and GRU cells. The names and parameters of the GKN cell 
